...
#Players Stats
ruta_archivo <- "/Users/nacho/Desktop/DV7/PowerBI_App_Antigua/docs/Leagues List.xlsx"
leagues_list <- read_excel(ruta_archivo) %>%
  filter(R_Code %in% c("England_ 1_2023","England_ 2_2023","England_ 3_2023",
                       "France_ 1_2023","France_ 2_2023", "France_ 3_2023",
                       "Germany_ 1_2023","Germany_ 2_2023", "Germany_ 3_2023",
                       "Italy_ 1_2023","Italy_ 2_2023","Italy_ 3_2023",
                       "Spain_ 1_2023","Spain_ 2_2023","Spain_ 3_2023"))
...
player_stats_2013_raw <- players_stats

#Crear columna de Competition y Season
player_stats_2013_raw <- player_stats_2013_raw %>%
  mutate(Split_Code = str_split(R_Code, "_", simplify = TRUE)) %>%
  mutate(Competition = paste(Split_Code[, 1], Split_Code[, 2]),
         Season = Split_Code[, 3]) %>%
  mutate(Competition = gsub("_", " ", Competition)) %>%
  select(-Split_Code)

# Exportar df a excel
# Especificar la ruta y el nombre del archivo de Excel
ruta_archivo_excel <- "/Users/nacho/Desktop/DV7/PowerBI_App_Antigua/data/Raw/player_stats_2018_2022_raw.xlsx"
